...
export default function Coifficient() {
  const [activeRects, setActiveRects] = useState([2, 9, 15, 21, 28, 35, 42]);
      ...
      const newLinePaths = targetIndexes
        .map((indexes) =>
          indexes.includes(index)
            ? createPathFromIndexes(indexes) + dataItem.endpath
            : ""
        )
        .filter((path) => path !== "");
  ...
  return (
    <div className=" h-[70vh] relative my-40 ">
      <svg width="58" className=" ml-5  " height="513" viewBox="0 0 58 513" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <svg
        ...
        className=" !absolute top-12 z-30 left-24 "
      >
        ...
        <motion.path
          key={pathKey} // crutial for the path to animate
          d={linePath}
          stroke="white"
          strokeWidth="5"
