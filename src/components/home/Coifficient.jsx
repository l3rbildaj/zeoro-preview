...
const data = [
  ...
  {
    stroked: 15,
    endpath: "5H446.5V150.5H615.5",
    title: "WEBSITE DEVELOPMENT",
    description: "Sapien eget proin massa nisi interdu morbi sed cras mattis egestas eros Sapien eget proin massa nisi int morbi sed cras mattis egestas"
  },
  {
    stroked: 20,
    endpath: "5H446.5V200.5H615.5",
    title: "WEBSITE DESIGN",
    description: "Sapien eget proin massa nisi interdu morbi sed cras mattis egestas eros Sapien eget proin massa nisi int morbi sed cras mattis egestas"
  },
  {
  ...
  {
    stroked: 44,
    endpath: "5H446.5V158.5H615.5",
    title: "WEBSITE DESIGN",
    description: "Sapien eget proin massa nisi interdu morbi sed cras mattis egestas eros Sapien eget proin massa nisi int morbi sed cras mattis egestas"
  },
  {
    stroked: 29,
    endpath: "5H446.5V128.5H615.5",
    title: "WEBSITE DESIGN",
    description: "Sapien eget proin massa nisi interdu morbi sed cras mattis egestas eros Sapien eget proin massa nisi int morbi sed cras mattis egestas"
  },
  {
...
export default function Coifficient() {
  ...
  const handleRectClick = (index) => {
    ...
    if (dataItem) {
      const endPath = !isMobile ? dataItem.endpath : "V167.5L160 567.5"
      const newLinePaths =  targetIndexesMobile  
        .map((indexes) =>
          indexes.includes(index)
            ? createPathFromIndexes(indexes) + endPath
            : ""
        )
        .filter((path) => path !== "");
      ...
      if (newLinePaths.length > 0) {
        ...
        // Update activeRects to include the rectangles in the path
        const newActiveRects = targetIndexesTablet
  ...
  return (
    <div className=" justify-between md:h-[510px] flex relative my-20  mx-5 2xl:mx-20">
      <div className=" scale-75  xl:scale-90 2xl:scale-100 -ml-24 sm:-ml-20 xl:ml-0 ">
        <svg width="58" className=" ml-7 md:ml-5  " height="513" viewBox="0 0 58 513" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            return (
              <g key={index}>
                <motion.rect
                  ...
                  fill={activeRects.includes(index) ? "black" : rect.fill}
                  animate={{
                    fill: activeRects.includes(index) ? "black" : "#505050",
                  }}
      ...
      <div className=" bg-black w-3/6 pl-20  flex flex-col h-full justify-center items-start " >
        {isLoading ? (
          <BlurIn>
          ...
          <>
            <TypingEffect delay={"0.04"} pathKey={pathKey} text={item.title} className=" text-white text-4xl font-semibold " />
            <TypingEffect
              pathKey={pathKey}
              text={item.description}
              className=" text-[#505050] text-2xl  "
