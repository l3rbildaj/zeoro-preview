...
import img1_mobile from "@/assets/exe/img1_mobile.png";
    ...
    <Layout>
      ...
      <div className=" px-5 md:px-10 ">
        ...
        <AnimatedText
          ...
          stagger={0.01}
          className={
            " mt-5 text-xl sm:text-2xl text-white flex flex-wrap max-w-[670px]  font-extrabold "
          }
        />
      ...
      <RevealImage
        classNameImg={" h-screen object-cover"}
        className="w-full h-[500px] md:h-screen relative my-20 overflow-hidden"
        src={img1}
      />
      ...
      <RevealImage
        className="w-full hidden md:flex relative my-20 overflow-hidden"
        src={img2}
      />
      <RevealImage
        className="w-full flex h-[250px] md:hidden relative my-20 overflow-hidden"
        src={img1_mobile}
      />
